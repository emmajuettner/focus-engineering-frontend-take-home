...
- `pnpm install` : downloads all the dependencies for the app
- `pnpm run server` : starts the backend API.
- `pnpm start` : starts the frontend React app. Changes will cause a reload
...
- If you encounter an issue with sqlite3 native bindings during install, try running `pnpm rebuild better-sqlite3`
